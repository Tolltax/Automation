...
public class AllResolutionScreenShot {
...
//		driver.findElement(By.id("signin_btnlogin")).click();
	...
	//800,  1024, 768 , 1280, 1366 , 1024,  1366, 1920, 1440, 1680, 1920, 2000, 2048, 2393, 2560, 2560, 3440, 5120
	//1280, 1366, 1024, 800,  1024,  768,   768,  1080,  900, 1050, 1200, 2000, 1152, 1346, 1080,  1440, 1440, 1440 
	
	{
         ...
         String n [] = new String[] {"http://brandsharafdguat.cstechns.com/"};
      	...
      	{	        
 	                 ...
 	                 Thread.sleep(3000);
                       ...
                       driver.manage().window().setSize(dimension);
	                     ...
	                     ImageIO.write(fpScreenshot.getImage(),"jpeg",new File("C://Users//cstechmk02//Desktop//sharaf_Screenshot//TestRun2//"+ s +width[i] +"X" +height[i]+ ".jpeg"));
